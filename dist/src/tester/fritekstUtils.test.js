import { dobbelTabellTilStreng, finnAntallTegnLagtTil, finnEndringsIndeks, finnTabellIndeksOgNyttFritekstElement, sanityTekstObjektTilStreng, } from '../utils/fritekstUtils';
...
describe('test av sanityTekstObjektTilStreng()', () => {
    it('gitt tekst uten markDefs og marks', () => {
        ...
        expect(streng).toBe('Dette er en en plain tekst uten flettefelt og bold-text');
    });
    it('gitt tekst med markDefs', () => {
        const testObjekt = sanityTekstMedFlettefelt;
        const streng = sanityTekstObjektTilStreng(testObjekt);
        expect(streng).toBe('Vi har beregnet dette både ut ifra arbeidsinntekten din og [stønad] du får fra oss. Dette gir en forventet årsinntekt på [beløp] kroner.');
    });
});
...
describe('test av finnTabellIndeksOgNyttFritekstElement(HTML)', () => {
    ...
    describe('gitt endringstype = eksisterendeTegnEndret', () => {
        it('endring i første element', () => {
            const nyFritekst = '<p>Tekst Nr 1.</p><p>Tekst nr 2.</p><p>Tekst nr 3.</p>';
            const endringsIndeks = 9;
            const antallTegnLagtTil = 0;
            const { tabellIndeks, nyttFritekstElement } = finnTabellIndeksOgNyttFritekstElement(endringsIndeks, nyFritekst, fritekstTabellKopi, antallTegnLagtTil, 0);
        ...
        it('flere tegn endret', () => {
            const nyFritekst = '<p>XXXXX nr 1.</p><p>Tekst nr 2.</p><p>Tekst Nr 3.</p>';
    ...
    describe('gitt endringstype = tegnLagtTil', () => {
        ...
        it('flere tegn lagt til', () => {
            const nyFritekst = '<p>TTTTTTTTTekst nr 1.</p><p>Tekst nr 2.</p><p>Tekst nr 3..</p>';
